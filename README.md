...
The main intention of Symp framework is to serve as a virtual machine and compiling target from embedded higher level programming frameworks. Its syntax and semantics are very simple, making it more-or-less trivial for implementation as an interpreter or compiler.
